...
def create():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("post_bp.post_table"))
...
def update(id):
    ...
    if current_user.id != get_post.user_id:
        flash("You cannot delete other's post", category=("warning"))
        return redirect(url_for('post_bp.post_detail', id=id))
    ...
    if form.validate_on_submit():
        ...
        flash("Post is updated", category=("access"))
        return redirect(url_for('post_bp.post_detail', id=id))
...
def delete(id):
    ...
    if current_user.id == get_post.user_id:
        ...
        db.session.commit()
        flash("Post is deleted", category=("success"))
    else:
        flash("You cannot delete other's post", category=("warning"))
...
def create_category():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("Category is created", category=("success"))
        return redirect(url_for("post_bp.category_list"))
...
def update_category(category_id):
    ...
    if form.validate_on_submit():
        ...
        flash("Category is updated", category=("success"))
        return redirect(url_for("post_bp.category_list"))
...
def delete_category(category_id):
    ...
    db.session.commit()
    flash("Category is deleted", category=("success"))
    return redirect(url_for("post_bp.category_list"))
...
def create_tag():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("Tag is created", category=("success"))
        return redirect(url_for("post_bp.tag_list"))
...
def update_tag(tag_id):
    ...
    if form.validate_on_submit():
        ...
        flash("Tag is updated", category=("success"))
        return redirect(url_for("post_bp.tag_list"))
...
def delete_tag(tag_id):
    ...
    db.session.commit()
    flash("Tag is deleted", category=("success"))
    return redirect(url_for("post_bp.category_list"))