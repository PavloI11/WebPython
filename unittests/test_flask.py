...
class UserTestCase(BaseTestCase):
    ...
    def test_login_user(self):
        with self.client:
            ...
            self.assertIn(u"Login is successful", response.data.decode('utf8'))
    ...
    def test_login_user_remember_me_error(self):
        with self.client:
            ...
            self.assertIn(u"remember yourself", response.data.decode('utf8'))
    ...
    def test_get_account_page(self):
        ...
        with self.client:
            ...
            self.assertIn(u"You are login", response.data.decode('utf8'))
    ...
    def test_update_account_info(self):
        ...
        with self.client:
            ...
            self.assert200(response)
            self.assertIn(u"Account is updated", response.data.decode('utf8'))
...
class HomePageTestCase(BaseTestCase):
    def test_main_page_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(u"Ласкаво просимо", response.data.decode('utf8'))

    def test_about_view(self):
        response = self.client.get('/about', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(u"PostgreSQL", response.data.decode('utf8'))

    def test_projects_view(self):
        response = self.client.get('/projects', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(u"проекти", response.data.decode('utf8'))

    def test_contact_view(self):
        response = self.client.get('/contact', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
        self.assertIn(u"запити", response.data.decode('utf8'))
